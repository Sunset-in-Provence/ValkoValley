    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-full mt-2 w-64 sm:w-72 bg-surface rounded-card shadow-elevated border border-border z-50 max-h-[70vh] overflow-y-auto">
