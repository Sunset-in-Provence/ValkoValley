...
const examQuestions = [
  ...
  {
    category: 'aoyin',
    question: '敖尹已公布的PV里提到的翻窗内容，对应的是什么剧情？',
    options: [
      'A. 主线第一章·初遇之章',
      'B. 牵绊之章',
      'C. 终焉之章',
  ...
  {
    category: 'aoyin',
    question: '敖尹说过"我们的气味"，闻起来像什么？',
    options: [
      'A. 清晨的露水、午后的烈日、傍晚的炊烟、深夜的寂静、老旧的书页',
      'B. 旷野、大地、草原、风、溪流山川、刚升起的月亮、炉子上烤坏的煎饼',
      'C. 松林间的雾气、晒过的棉被、刚切的青草、古旧的木箱、微凉的薄荷',
      'D. 海边的盐粒、橡木的苔藓、冬日的暖炉、新翻的泥土、铁锈的门环',
    ],
    correctIndex: 1,
  },
  {
